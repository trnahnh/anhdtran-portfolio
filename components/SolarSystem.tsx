...
const PLANETS = [
  { id: 1, orbitR: 72,  size: 10, speed: 9,  color: "rgba(180,200,230,0.85)", dash: "2 3" },
  { id: 2, orbitR: 118, size: 15, speed: 17, color: "rgba(210,170,120,0.85)", dash: "3 4", hasRings: true },
  { id: 3, orbitR: 170, size: 9,  speed: 27, color: "rgba(140,175,220,0.85)", dash: "2 2" },
  { id: 4, orbitR: 228, size: 18, speed: 44, color: "rgba(155,205,155,0.85)", dash: "4 3" },
] as const;

const BG_FLOATERS = [
  { id: 1, left: "6%",  top: "16%", size: 26, duration: 20, color: "rgba(180,200,230,0.3)" },
  { id: 2, left: "86%", top: "26%", size: 18, duration: 29, color: "rgba(210,170,120,0.3)" },
  { id: 3, left: "75%", top: "66%", size: 22, duration: 25, color: "rgba(140,175,220,0.3)" },
  { id: 4, left: "11%", top: "74%", size: 14, duration: 34, color: "rgba(155,205,155,0.3)" },
];
...
function SunSVG() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48">
      ...
      <circle cx="24" cy="24" r="20" fill="none" stroke="rgba(255,215,60,0.22)" strokeWidth="1" strokeDasharray="4 3" />
      <circle cx="24" cy="24" r="14" fill="none" stroke="rgba(255,215,60,0.38)" strokeWidth="1" strokeDasharray="2 2" />
...
function PlanetSVG({
  size, color, dash, hasRings,
}: {
  size: number; color: string; dash: string; hasRings?: boolean;
}) {
  const r = size / 2;
  return (
    <svg
    ...
    >
      ...
      <circle cx={r} cy={r} r={r - 1} fill={withOpacity(color, 0.11)} stroke={color} strokeWidth="1" strokeDasharray={dash} />
    ...
    >
      ...
      <motion.div
        ...
        >
          ...
          <div style={{ position: "absolute", transform: `translate(-50%, -50%) scale(${scale})`, transformOrigin: "center center" }}>
            {/* Sun */}
            <div style={{ position: "absolute", transform: "translate(-24px, -24px)" }}>
              <SunSVG />
            </div>
